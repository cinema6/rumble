    ...
    packageRequest.onload = function(event) {
        ...
        requirejs({
            ...
            paths: {
                ...
                angular: libUrl('angular/v1.3.6-0-g6ad109e/angular'),
                angularAnimate: libUrl('angular/v1.3.6-0-g6ad109e/angular-animate'),
                angularSanitize: libUrl('angular/v1.3.6-0-g6ad109e/angular-sanitize'),
                angularTouch: libUrl('angular/v1.3.6-0-g6ad109e/angular-touch'),
                angularMocks: libUrl('angular/v1.3.6-0-g6ad109e/angular-mocks'),
                c6uilib: libUrl('c6ui/v3.5.1-0-gc8468d2/c6uilib'),
                c6log: libUrl('c6ui/v3.5.1-0-gc8468d2/c6log'),
